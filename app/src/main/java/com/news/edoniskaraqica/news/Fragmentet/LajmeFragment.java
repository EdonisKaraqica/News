 ...
 */
public class LajmeFragment extends Fragment {
    private RecyclerView newsRecyclerView;
    private static final String KEY_INDEX="news_index";


    public LajmeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView1=inflater.inflate( R.layout.fragment_lajme,null );
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        call = NewsAPI.getApi().getArticles4();
