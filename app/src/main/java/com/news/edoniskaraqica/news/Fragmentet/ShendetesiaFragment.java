 ...
 */
public class ShendetesiaFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView1=inflater.inflate( R.layout.fragment_shendetesia,null );
        newsRecyclerView=(RecyclerView) rootView1.findViewById( R.id.activity_main_recyclerview_shendetesia);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        call = NewsAPI.getApi().getArticles5();
